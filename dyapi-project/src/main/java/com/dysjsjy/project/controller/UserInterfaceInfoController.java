...
import com.dysjsjy.project.constant.UserConstant;
import com.dysjsjy.project.exception.BusinessException;
import com.dysjsjy.project.model.dto.userinterfaceinfo.UserInterfaceInfoAddRequest;
import com.dysjsjy.project.model.dto.userinterfaceinfo.UserInterfaceInfoQueryRequest;
import com.dysjsjy.project.model.dto.userinterfaceinfo.UserInterfaceInfoUpdateRequest;
...
public class UserInterfaceInfoController {
    ...
    public BaseResponse<Boolean> updateUserInterfaceInfo(@RequestBody UserInterfaceInfoUpdateRequest userInterfaceInfoUpdateRequest,
        ...
        //仅本人或管理员可以修改
        if (!oldUserInterfaceInfo.getId().equals(loginUser.getId()) && !userService.isAdmin(request)) {
            throw new BusinessException(ErrorCode.NO_AUTH_ERROR);
        }
